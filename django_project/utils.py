...
def take_screenshot(url, output_file):
  ...
  try:
    ...
    snap_temp_root = "/root/snap/chromium/common/hotstuff"
    os.makedirs(snap_temp_root, exist_ok=True)

    with tempfile.TemporaryDirectory(dir=snap_temp_root) as temp_dir:
      ...
      hti.browser._subprocess_run_kwargs["timeout"] = 20
